		...
		<div id="dd" class="easyui-dialog" title="添加管理员" modal=true
			...
			<form id="myform" method="post" style="text-align: center;">
				...
				<div>
					...
					<input class="easyui-validatebox" type="text" name="bookName"
						required="true"></input>
				</div>
				<div>
					<label for="userName">
				...
				<div>
					...
					<input  type="text" class="easyui-datebox"  name="borrowDate">
				...
				<div>
					...
					<input  type="text" class="easyui-datebox"  name="returnDate">
